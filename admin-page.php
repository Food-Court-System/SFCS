		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
              ...
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    <thead>
                      <tr>
                        ...
                        <th style = "width: 150px">Change Image</th>
                        <th>Name</th>
                        <th>Unit Cost</th>
				...
				{
          $food_pic= "images/Vendor/".$row['sfcsimage'];
          echo '<tr><td><img class="center" src="' .$food_pic . '" width="200px" alt="Cinque Terre"></td>';
          echo '<td style = "width: 150px"><div class="input-field col s12 "><label for="'.$row["id"].'_sfcsimage"></label>';
          echo '<input style = "width: 150px" value = "'.$row["sfcsimage"].'" id="'.$row["id"].'_sfcsimage" name="'.$row['id'].'_sfcsimage" type="file" accept="image/*" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Add Image</th>
                      </tr>
                    </thead>
          ...
          echo '<td><div class="input-field col s12  "><label for="sfcsimage"></label>';
          echo '<input id="sfcsimage" type="file" accept="image/*" name="sfcsimage" required size="chars""></td>';                   
					echo '<td></tr>';
				?>
                    </tbody>
</table>
