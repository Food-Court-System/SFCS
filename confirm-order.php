...
<?php
    ...
    echo '<li class="collection-item">
        <div class="row">
            <div class="col s3">
                <p class="collections-title"><strong>Food Name</strong></p>
            </div>
            <div class="col s2">
                <span><strong>Food Id</strong></span>
            </div>
            <div class="col s2">
            ...
            <div class="col s3">
                <span><strong>Path Cost</strong></span>
            </div>
        </div>
        </li>';
	...
	foreach ($_POST as $key => $value)
	{
		...
		$path_cost = $value*$price;
		echo '<li class="collection-item">
        <div class="row">
            <div class="col s3">
            <p class="collections-title"><strong>#'.$item_name.'</strong></p>
            </div>
            <div class="col s2">
            <span>'.$food_id.'</span>
            </div>
    ...
    echo '<li class="collection-item">
        <div class="row">
            ...
            <div class="col s2">
                <span class="collections-title"><strong>Total:</strong> </span>
            </div>
